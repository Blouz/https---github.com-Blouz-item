...
<html lang="en">
    <head>
        ...
        <!-- Customizable CSS -->
        <link rel="stylesheet" href="/statics/assets/css/main.css">
        <link rel="stylesheet" href="/statics/assets/css/green.css">
        <link rel="stylesheet" href="/statics/assets/css/owl.carousel.css">
        <link rel="stylesheet" href="/statics/assets/css/owl.transitions.css">
        <link rel="stylesheet" href="/statics/assets/css/animate.min.css">

        <!-- Demo Purpose Only. Should be removed in production -->
        <link rel="stylesheet" href="/statics/assets/css/config.css">

        <link href="/statics/assets/css/green.css" rel="alternate stylesheet" title="Green color">
        <link href="/statics/assets/css/blue.css" rel="alternate stylesheet" title="Blue color">
        <link href="/statics/assets/css/red.css" rel="alternate stylesheet" title="Red color">
        <link href="/statics/assets/css/orange.css" rel="alternate stylesheet" title="Orange color">
        <link href="/statics/assets/css/navy.css" rel="alternate stylesheet" title="Navy color">
        <link href="/statics/assets/css/dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <div class="basket-item-count">
                    ...
                    <img src="/statics/assets/images/icon-cart.png" alt="" />
                </div>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                    <img alt="" src="/statics/assets/images/products/product-small-01.jpg" />
                                </div>
                            </div>
...
<div class="row">
    ...
    <div class="dropdown-banner-holder">
        <a href="#"><img alt="" src="/statics/assets/images/banners/banner-side.png" /></a>
    </div>
</div>
<!-- ================================== MEGAMENU VERTICAL ================================== -->                        
                    </li>
    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/banners/banner-narrow-01.jpg" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="category-grid-2.html">
                ...
                <img class="banner-image" alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/banners/banner-narrow-02.jpg" />
            </a>
        </div>
    </div><!-- /.container -->
                    ...
                    <div class="product-grid-holder">
                        <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-01.jpg" />
                                </div>
                                <div class="body">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-02.jpg" />
                                </div>
                                <div class="body">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-04.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
                    ...
                    <div class="product-grid-holder">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-03.jpg" />
                                </div>
                                <div class="body">
                                    <div class="label-discount clear"></div>
                                    <div class="title">
            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-05.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-06.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-07.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-08.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-09.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-10.jpg" />
                            </div>
                            <div class="body">
                                <div class="label-discount clear"></div>
                                <div class="title">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        <div class="single-product-gallery-item" id="slide1">
                            <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                                <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-gallery-01.jpg" />
                            </a>
            ...
            <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon red"><span>sale</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-11.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon blue"><span>new!</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-12.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="image">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-13.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon blue"><span>new!</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-14.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        <div class="ribbon green"><span>bestseller</span></div> 
                        <div class="image">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-15.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
                ...
                <div class=" no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="image">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-16.jpg" />
                        </div>
                        <div class="body">
                            <div class="title">
        ...
        <div class="carousel-holder" >
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/statics/assets/images/brands/brand-01.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/statics/assets/images/brands/brand-02.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/statics/assets/images/brands/brand-03.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
                
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/statics/assets/images/brands/brand-04.jpg" />
                    </a>
                </div><!-- /.carousel-item -->
        ...
        <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-01.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-02.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">                        
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-03.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-04.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-05.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-06.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-07.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-08.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="/statics/assets/images/blank.gif" data-echo="assets/images/products/product-small-09.jpg" />
                        </a>
                    </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="/statics/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="/statics/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="/statics/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="/statics/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<!-- ============================================================= FOOTER : END ============================================================= -->   </div><!-- /.wrapper -->
    ...
    <script src="/statics/assets/js/jquery-1.10.2.min.js"></script>
    <script src="/statics/assets/js/jquery-migrate-1.2.1.js"></script>
    <script src="/statics/assets/js/bootstrap.min.js"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
    <script src="/statics/assets/js/gmap3.min.js"></script>
    <script src="/statics/assets/js/bootstrap-hover-dropdown.min.js"></script>
    <script src="/statics/assets/js/owl.carousel.min.js"></script>
    <script src="/statics/assets/js/css_browser_selector.min.js"></script>
    <script src="/statics/assets/js/echo.min.js"></script>
    <script src="/statics/assets/js/jquery.easing-1.3.min.js"></script>
    <script src="/statics/assets/js/bootstrap-slider.min.js"></script>
    <script src="/statics/assets/js/jquery.raty.min.js"></script>
    <script src="/statics/assets/js/jquery.prettyPhoto.min.js"></script>
    <script src="/statics/assets/js/jquery.customSelect.min.js"></script>
    <script src="/statics/assets/js/wow.min.js"></script>
    <script src="/statics/assets/js/scripts.js"></script>

    <!-- For demo purposes – can be removed on production -->
    
    <script src="/statics/switchstylesheet/switchstylesheet.js"></script>
