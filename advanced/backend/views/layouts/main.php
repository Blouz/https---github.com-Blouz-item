            ...
            <ul class="nav pull-right">                
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= Url::to(['uploads/upfile']) ?>">个人信息管理</a></li>
                        <li><a href="#">修改密码</a></li>
                        <li><a href="#">订单管理</a></li>
                    </ul>
                </li>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><?= Html::a("品牌添加",['brand/add',''=>''])?></li>
                    <li><?= HTMl::a("品牌列表",['brand/list',''=>''])?></li>
                    <li><?= HTMl::a("分类添加",['category/type',''=>''])?></li>
            ...
            <li>
                <a class="dropdown-toggle" href="#">
                    ...
                    <ul class="submenu">
                    <li><?= Html::a("属性添加",['attrbute/attrbutelist',''=>''])?></li>
                    <li><?= HTMl::a("属性列表",['attrbute/attrbuteadd',''=>''])?></li>
                    <li><?= HTMl::a("属性添加",['attrbute/goodadd',''=>''])?></li>
                    <li><?= HTMl::a("属性列表",['attrbute/goodadds',''=>''])?></li>
                </ul>
                </a>
            </li>
            <li>
